...
function graphqlServerOperate(schema, source, rootValue, variableValues, operationName) {
    return __awaiter(this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, withPostGraphileContext({
                        pgPool: pgPool
                        // jwtToken: jwtToken,
                        // jwtSecret: "...",
                        // pgDefaultRole: "..."
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, graphql(schema, // The schema from `createPostGraphileSchema`
                                    source, rootValue, __assign({}, context
                                    // TODO jwtClaims?
